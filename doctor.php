  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="aboutleft pull-right"> <span><a href="index.php">Home</a> / </span><span>Doctors</span> </div>
        <div class="clr"></div>
      </div>
    </div>
  </div>
...
<div class="container">
	<div class="doctor content">
    	<div class="row">
            <div class="col-sm-12">
         <?php
		$sql=mysql_query("select * from tbl_member where member_type='Doctor' and member_status='1'");
