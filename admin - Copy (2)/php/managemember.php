...
//step:2
  ...
  $query = mysql_query("SELECT * FROM tbl_member"); //Counting total number of rows in the table 'data',
...
//step:7
    $res = mysql_query("SELECT * FROM tbl_member LIMIT ".$per_page." OFFSET ".$offset);
