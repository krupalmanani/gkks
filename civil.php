  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="aboutleft pull-right"> <span><a href="index.php">Home</a> / </span><span>Civil Eng.</span> </div>
        <div class="clr"></div>
      </div>
    </div>
  </div>
...
<div class="container">
	<div class="content">
    	<div class="row">
            <div class="col-sm-12">
            	<?php
		$sql=mysql_query("select * from tbl_member where member_type='Civil Engineer' and member_status='1'");
