...
<div>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="aboutright pull-left">
            <h4><a href="brides.php" class="a" style="text-decoration:underline;color:#30527C">Bride List</a> <a href="boys.php" class="a">Groom List</a></h4>
          </div>
          <div class="aboutleft pull-right"> <span><a href="index.php">Home</a> / </span><span><a href="matrimonial.php">Matrimonial</a> / </span><span>Bride</span> </div>
          <div class="clr"></div>
        </div>
      </div>
    </div>
  ...
  <div id="result"></div>
    <div id="record">
        <?php
		$sql=mysql_query("select * from tbl_metrimonial where gender='Female' and status='1'");
