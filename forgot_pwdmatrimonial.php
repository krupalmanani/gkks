...
<?php
	$message='<a href="reset_matrimonial.php?mail="'.$_GET['toemail'].'">Click Here</a>To reset you password';
	$to=$_GET['toemail'];
...
<fieldset>
    ...
    <a href="reset_matrimonial.php?mail=<?php echo $_GET['toemail'];?>">Click Here</a>To reset you password
