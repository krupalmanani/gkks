  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="aboutleft pull-right"> <span><a href="index.php">Home</a> / </span><span>Any Graduate</span> </div>
        <div class="clr"></div>
      </div>
    </div>
  </div>
...
<div class="container">
	<div class="graduate content">
    	<div class="row">
            <div class="col-sm-12">
            	<?php
		$sql=mysql_query("select * from tbl_member where member_type='Any Graduate' and member_status='1' order by member_first_name");
