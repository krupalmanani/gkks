    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="aboutright pull-left">
          <h4>Goverment Employee</h4>
        </div>
        <div class="aboutleft pull-right"> <span><a href="index.php">Home</a> / </span><span>Gov.Employee</span> </div>
        <div class="clr"></div>
      </div>
    </div>
  </div>
...
<div class="container">
	<div class="goverment content">
    	<div class="row">
            <div class="col-sm-12">
            	<?php
		$sql=mysql_query("select * from tbl_member where member_type='Goverment Employee' and member_status='1'");
